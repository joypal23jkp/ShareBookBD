            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">A Book Sharing System
                                    <span>to find and share your books</span>
                                </h1>
                                <p class="lead  text-white">The system comes with a book sharing platform. You can share your books with equivalent cost and find one</p>
                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary text-uppercase">Novel</h6>
                                    <p class="description mt-3">This is websites is giving you permission to add your own book type.</p>
                                    <div>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-success text-uppercase">Literature</h6>
                                    <p class="description mt-3">This is websites is giving you permission to add your own book type.</p>
                                    <div>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-warning text-uppercase">Business</h6>
                                    <p class="description mt-3">This is websites is giving you permission to add your own book type.</p>
                                    <div>
                ...
                <div class="row row-grid align-items-center">
                    ...
                    <div class="col-md-6 order-md-1">
                        <div class="pr-md-5">
                            ...
                            <p>Share-Book is customer to customer relationship application. One customer shares book to another customer and build a friendly communication.</p>
                            <ul class="list-unstyled mt-5">
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-settings-gear-65"></badge>
                                        <h6 class="mb-0">Amazing BookSharing Feature</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-html5"></badge>
                                        <h6 class="mb-0">Amazing Supporting Team.</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-satisfied"></badge>
                                        <h6 class="mb-0">Super friendly environment.</h6>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="card bg-default shadow border-0">
                            ...
                            <blockquote class="card-blockquote">
                                ...
                                <h4 class="display-3 font-weight-bold text-white">About System</h4>
                                <p class="lead text-italic text-white">This system you are experiencing is fully designed or modified by Vue.js ( A JavaScript Frameword ).
                                    A single page application like ShareBook always gives you better using compatibility. </p>
                            </blockquote>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="pl-md-5">
                            ...
                            <h3>System User</h3>
                            <p class="lead">Book Lovers are going to use the System.</p>
                            <p>******</p>
                            ...
                            <a href="#" class="font-weight-bold text-warning mt-5">A beautiful Website to communicate with booksharing</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section section-lg">
            <div class="container">
                <div class="row justify-content-center text-center mb-lg">
                    <div class="col-lg-8">
                        <h2 class="display-3">The amazing Users</h2>
                        <p class="lead text-muted">According to the system these are top rated users who has good interaction with the system environment.</p>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row justify-content-center mt--300">
                    <div class="col-lg-8">
                        <card gradient="secondary" shadow body-classes="p-lg-5">
                            <h4 class="mb-1">Want to be a member??</h4>
                            <p class="mt-0">Your membership is very important to us.</p>
